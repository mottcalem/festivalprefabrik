...
export const metadata=pageMetadata({title:'Prefabrik Ev Modelleri',description:'Tek ve çift katlı prefabrik ev, çelik ev ve konteyner modellerimizi; planları ve teknik özellikleriyle inceleyin.',path:'/modeller',trPath:'/modeller',enPath:'/en/models'});
